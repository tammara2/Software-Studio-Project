...
const Dashboard1: FunctionComponent = () => {
  return (
    <div className="relative bg-beige w-full h-[1198px] overflow-hidden text-left text-base text-black font-poppins">
      <div className="absolute top-[187px] left-[377px] w-[968px] h-[151px] text-xl text-gray-900">
        <img
        ...
        <div className="absolute top-[30px] left-[63px] w-[878px] h-[88px]">
          <div className="absolute top-[2px] left-[0px] w-[482px] h-[84px]">
            <div className="absolute top-[0px] left-[104px] text-base tracking-[-0.01em] text-gray-400 inline-block">
            ...
            <img
              ...
              src="../group-103.svg"
            />
            <div className="absolute top-[63px] left-[104px] w-[124px] h-[20px] text-sm text-green">
          ...
          <div className="absolute top-[0px] left-[319px] w-[559px] h-[86px] text-base text-gray-400">
            ...
            <img
              ...
              src="../group-104.svg"
            />
            <div className="absolute top-[65px] left-[104px] w-[121px] h-[20px] text-sm text-brown">
          ...
          <div className="absolute top-[2px] left-[638px] w-[204px] h-[84px]">
            ...
            <img
              ...
              src="../group-105.svg"
            />
            <div className="absolute top-[63px] left-[104px] w-[100px] h-[20px] text-sm text-green">
              <div className="absolute top-[2px] left-[23px] tracking-[-0.01em] inline-block">
                <b>11%</b>
      ...
      <div className="absolute top-[399px] left-[359px] w-[986px] h-[693px] text-xs text-gray-800">
        <img
          className="absolute top-[-50px] left-[-60px] rounded-[30px] w-[1106px] h-[813px]"
          alt=""
          src="../rectangle-16.svg"
        />
        <div className="absolute top-[49.5px] left-[742.64px] w-[185.27px] h-[69.67px] text-sm text-gray-600">
        ...
        <div className="absolute top-[44px] left-[59.66px] text-[22px] tracking-[-0.01em] font-semibold text-black inline-block w-[161.72px] h-[60.5px]">{`Waste Use `}</div>
        <div className="absolute top-[111.83px] left-[62.8px] text-base tracking-[-0.01em] text-gray-400 inline-block w-[172.71px] h-[38.5px]">
          Monthly Use
        </div>
      ...
      <div className="absolute top-[-5px] left-[0px] w-[306px] h-[1198px]">
        ...
        <div className="absolute top-[1047px] left-[60px] w-[150px] h-[100px]">
          ...
          <div className="absolute top-[55px] left-[22px] text-sm tracking-[0.01em] text-gray-700 inline-block">
            Project Manager
          </div>
        </div>
      ...
      <div className="absolute top-[101px] left-[401px] text-lg font-medium inline-block">
        The Nueva School
      </div>
    </div>
  );
